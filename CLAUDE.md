...
**Version:** `4.1.0` — defined in the plugin header and as `CIG_VERSION` constant in `custom-woocommerce-invoice-generator.php`. Update both places when bumping.
...
|----------|-------|---------|
| `CIG_VERSION` | `'4.1.0'` | Plugin version (update in header + constant) |
