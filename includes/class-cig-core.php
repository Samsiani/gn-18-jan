        ...
        if ($should_enqueue) {
            ...
            $localize_data = [
                ...
                'i18n' => [
                    ...
                    'saving' => __('Saving...', 'cig'),
                    'save_invoice' => __('Save Invoice', 'cig'),
                    'update_invoice' => __('Update Invoice', 'cig'),
                    'updated_successfully' => __('Updated successfully.', 'cig'),
                    'saved_successfully' => __('Saved successfully.', 'cig'),
                    'save_failed' => __('Save failed', 'cig'),
                    'server_error' => __('Server Error', 'cig'),
                    'invoice_locked' => __('This invoice is locked.', 'cig'),
                    'fill_required_fields' => __('Please fill in the required fields:', 'cig'),
                    'buyer_name' => __('Buyer Name', 'cig'),
                    'tax_id' => __('Tax ID', 'cig'),
                    'phone' => __('Phone', 'cig'),
                    'stock_warnings_proceed' => __('Stock warnings present. Proceed?', 'cig'),
                    'auto_correct_to' => __('Auto-correct to', 'cig'),
                    'invoice_fully_paid' => __('Invoice is already fully paid.', 'cig'),
                    'enter_valid_amount' => __('Please enter a valid amount (greater than 0).', 'cig'),
                    'enter_date' => __('Please enter a date.', 'cig'),
                    'confirm_delete_payment' => __('Are you sure you want to delete this record?', 'cig'),
                    'no_payments_recorded' => __('No payments recorded', 'cig'),
                    'processing' => __('Processing...', 'cig'),
                    'mark_as_sold' => __('Mark as Sold', 'cig'),
                    'confirm_mark_sold' => __('Are you sure you want to mark reserved products as sold?', 'cig'),
                    'connection_error' => __('Connection error', 'cig'),
                    'code_label' => __('Code:', 'cig'),
                    'warranty_6m' => __('6 Months', 'cig'),
                    'warranty_1y' => __('1 Year', 'cig'),
                    'warranty_2y' => __('2 Years', 'cig'),
                    'warranty_3y' => __('3 Years', 'cig'),
                    'sold' => __('Sold', 'cig'),
                    'reserved' => __('Reserved', 'cig'),
                    'canceled' => __('Canceled', 'cig'),
                    'overpaid' => __('overpaid', 'cig'),
                    'paid_label' => __('Paid:', 'cig'),
                ],
        ...
        if ($enqueue_stock_table) {
            ...
            wp_localize_script('cig-products-stock-table', 'cigStockTable', [
                ...
                'i18n'       => [
                    ...
                    'error_loading_data' => __('Error loading data.', 'cig'),
                    'error_saving_cart' => __('Error saving to cart', 'cig'),
                    'out_of_stock' => __('Out of Stock', 'cig'),
                    'no_image' => __('No Image', 'cig'),
                    'remove' => __('Remove', 'cig'),
                    'showing_results' => __('Showing %1$s-%2$s of %3$s products', 'cig'),
                    'prev' => __('Prev', 'cig'),
                    'next' => __('Next', 'cig'),
                    'saved' => __('Saved', 'cig'),
                    'error' => __('Error', 'cig'),
            ...
            if (!wp_script_is('cig-invoice', 'enqueued')) {
                wp_localize_script('cig-mini-dashboard', 'cigAjax', [
                    ...
                    'i18n'     => [
                        'loading' => __('Loading...', 'cig'),
                        'error'   => __('Error', 'cig'),
                        'loading_invoices' => __('Loading invoices...', 'cig'),
                        'no_invoices_found' => __('No invoices found', 'cig'),
                        'error_loading_invoices' => __('Error loading invoices', 'cig'),
                        'today' => __('Today', 'cig'),
                        'never' => __('Never', 'cig'),
                        'sold' => __('Sold', 'cig'),
                        'reserved' => __('Reserved', 'cig'),
                        ...
                        'view' => __('View', 'cig'),
                        'edit' => __('Edit', 'cig'),
                        'no_reservations_expiring' => __('No reservations expiring soon', 'cig'),
                        'day_left' => __('1 day left', 'cig'),
                        'days_left' => __('%d days left', 'cig'),
                    ]
                ]);
            }
        }
            ...
            if (!wp_script_is('cig-invoice', 'enqueued') && !wp_script_is('cig-mini-dashboard', 'enqueued')) {
                 wp_localize_script('cig-accountant', 'cigAjax', [
                    ...
                    'i18n'     => [
                        ...
                        'no_invoices_found' => __('No invoices found.', 'cig'),
                        'error_loading_data' => __('Error loading data.', 'cig'),
                        'error_updating_status' => __('Error updating status', 'cig'),
                        'error_saving_note' => __('Error saving note', 'cig'),
                        'connection_error' => __('Connection error', 'cig'),
                        'saving' => __('Saving...', 'cig'),
                        'save_note' => __('Save Note', 'cig'),
                        'no_consultant_note' => __('(No consultant note)', 'cig'),
                        'prev' => __('Prev', 'cig'),
                        'next' => __('Next', 'cig'),
                        'page_of' => __('Page %1$s of %2$s', 'cig'),
                        'partial' => __('Partial', 'cig'),
                        'view_consultant_note' => __('View Consultant Note', 'cig'),
                        'view_accountant_note' => __('View Accountant Note', 'cig'),
                        'edit_note' => __('Edit Note', 'cig'),
                        'rs_uploaded' => __('RS Uploaded', 'cig'),
                        'credit_installment' => __('Credit / Installment', 'cig'),
                        'receipt_full' => __('Full Receipt', 'cig'),
                        'corrected' => __('Corrected', 'cig'),
                    ]
                ]);
            }
        }
