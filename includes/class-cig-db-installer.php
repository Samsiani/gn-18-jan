...
class CIG_DB_Installer {
    ...
    private static function create_invoices_table($charset_collate) {
        ...
        $sql = "CREATE TABLE $table_name (
            ...
            is_credit_checked tinyint(1) DEFAULT 0,
            is_receipt_checked tinyint(1) DEFAULT 0,
            is_corrected tinyint(1) DEFAULT 0,
            accountant_note text,
            rs_uploaded_by bigint(20) DEFAULT NULL,
            rs_uploaded_date datetime DEFAULT NULL,
            PRIMARY KEY  (id),
