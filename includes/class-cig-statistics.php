    ...
    public function enqueue_assets($hook) {
        ...
        wp_localize_script('cig-statistics', 'cigStats', [
            ...
            'i18n' => [
                ...
                'select_both_dates'      => __('Please select both dates', 'cig'),
                'confirm_delete_record'  => __('Are you sure you want to delete this record?', 'cig'),
                'enter_valid_amount'     => __('Please enter a valid amount.', 'cig'),
                'select_date'            => __('Please select a date.', 'cig'),
                'saving'                 => __('Saving...', 'cig'),
                'confirm'                => __('Confirm', 'cig'),
                'error_saving_deposit'   => __('Error saving deposit.', 'cig'),
                'server_error'           => __('Server error.', 'cig'),
                'error_loading_external' => __('Error loading external balance data.', 'cig'),
                'no_deposit_history'     => __('No deposit history found.', 'cig'),
                'loading_products'       => __('Loading product performance...', 'cig'),
                'no_products_found'      => __('No products found', 'cig'),
                'error_loading_products' => __('Error loading products', 'cig'),
                'loading_users'          => __('Loading users...', 'cig'),
                'no_users_found'         => __('No users found', 'cig'),
                'error_loading_users'    => __('Error loading users', 'cig'),
                ...
                'loading_unpaid'         => __('Loading unpaid invoices...', 'cig'),
                'no_outstanding'         => __('No outstanding invoices found.', 'cig'),
                'error_loading_data'     => __('Error loading data.', 'cig'),
                'products_reserved'      => __('Products Reserved', 'cig'),
                'products_sold'          => __('Products Sold', 'cig'),
                'reserved_qty'           => __('Reserved Qty', 'cig'),
                'quantity_sold'          => __('Quantity Sold', 'cig'),
                'invoices'               => __('Invoices', 'cig'),
                'user_invoices'          => __('User Invoices', 'cig'),
                'no_fictive_invoices'    => __('No fictive invoices found', 'cig'),
                'error_loading_fictive'  => __('Error loading invoices', 'cig'),
                'loading_customers'      => __('Loading customers...', 'cig'),
                'no_customers_found'     => __('No customers found', 'cig'),
                'customer_invoices'      => __('Customer Invoices', 'cig'),
                'no_customer_invoices'   => __('No invoices found', 'cig'),
                'error_loading_details'  => __('Error loading details', 'cig'),
                'prev'                   => __('Prev', 'cig'),
                'next'                   => __('Next', 'cig'),
            ],
            'colors' => [
